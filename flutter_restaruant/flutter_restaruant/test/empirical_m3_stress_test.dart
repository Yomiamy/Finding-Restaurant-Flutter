...
void main() {
  group(
    'Empirical Stress Tests - Milestone 3 DTO & Domain Entity Separation',
    () {
      ...
      test('3. Edge cases in Category and Location formatting', () {
        ...
        const catNullTitle = RestaurantCategoryEntity(
          alias: 'cat1',
          title: null,
        );
        const catValidTitle = RestaurantCategoryEntity(
          alias: 'cat2',
          title: 'Bistro',
        );
        const restEntity1 = RestaurantEntity(
          categories: [catNullTitle, catValidTitle],
        );
