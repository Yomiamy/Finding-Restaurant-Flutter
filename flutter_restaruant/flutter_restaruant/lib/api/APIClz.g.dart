...
class _APIClz implements APIClz {
  ...
  Future<YelpSearchInfo> businessesSearch({
    ...
    final _options = _setStreamType<YelpSearchInfo>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<YelpRestaurantDetailInfo> business(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<YelpRestaurantDetailInfo>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<YelpReviewInfo> review(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<YelpReviewInfo>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
